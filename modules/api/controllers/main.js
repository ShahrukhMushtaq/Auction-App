...
main.signup = function (req, res, next) {
    ...
    var sql = "INSERT INTO users (name,email,password,age,phone,gender,location,userAvatar) VALUES ?";
    let userDB = [
        [req.body.name, req.body.email, hash, req.body.age, req.body.phone, req.body.gender, req.body.location, req.file.path]
    ];
